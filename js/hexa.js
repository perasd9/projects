    ...
    async function createPost(){
        ...
        document.querySelector(".all-posts-wrapper").innerHTML = `<div class = "single-post" data-post-id = "${post.id}">
                                                                    ...
                                                                    <div class = "post-actions">
                                                                        <p><b>Created: </b> ${user.username}</p>
                                                                        <p><b>Date: </b> ${post.created}</p>
                                                                        <div>
...
async function commentPostSubmit(event){
    ...
    if(user.username.includes("sandra") || user.email.includes("sandra")){
        mainPostElement.querySelector(".post-comments").innerHTML += `<div class = "single-comment"> <span style = "color: grey ; border:2px solid yellow; padding: 10px; margin-right: 15px ;"> <img src = "img/sandrakurva.jpeg" style = "height : 25px ; width : 25px">: ${user.username} :</span>${comment.content} </div>`;
    }
    else{
